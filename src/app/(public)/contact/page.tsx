            ...
            <div className="grid md:grid-cols-2 gap-12 w-full max-w-5xl items-center">
                ...
                >
                    <div className="space-y-6">
                        ...
                        <p className="text-lg md:text-xl text-neutral-500 font-medium leading-relaxed max-w-md">
                            {subtitle}
                        </p>
                    </div>
                    ...
                    <div className="p-8 rounded-3xl border border-white/[0.05] bg-white/[0.02] backdrop-blur-sm max-w-sm">
                        <h3 className="text-[10px] font-bold text-neutral-500 uppercase tracking-[0.2em] mb-4">Location</h3>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    <Label className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 ml-1">Name</Label>
                            ...
                            <div className="space-y-3">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 ml-1">Subject</Label>
                            ...
                            <div className="space-y-3">
                                <Label className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 ml-1">Message</Label>
