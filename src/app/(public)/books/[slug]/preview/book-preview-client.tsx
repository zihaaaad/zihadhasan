...
export default function BookPreviewClient({ book }: BookPreviewClientProps) {
 ...
 <div className="prose prose-invert prose-lg max-w-none prose-headings:text-white prose-p:text-gray-600 prose-p:leading-relaxed prose-strong:text-white border-l border-white/[0.05] pl-8">
 {book.previewContent ? (
