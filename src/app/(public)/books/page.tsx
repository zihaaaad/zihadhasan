...
export default function BooksPage() {
 ...
 {[1, 2, 3].map((i) => (
 <Skeleton key={i} className="h-[500px] rounded-[2rem] bg-white" />
 ))}
 </div>
 ) : books.length > 0 ? (
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
 ...
 >
 <GlassCard className="h-full p-0 overflow-hidden flex flex-col group hover:border-gray-200 transition-all duration-700 shadow-none border-white/[0.05] bg-white/[0.02] rounded-[2rem]">
 ...
 <span className="px-3 py-1 bg-white text-[9px] font-bold text-white/80 rounded-full border border-gray-200 uppercase tracking-widest">
 ...
 <span className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Starting from</span>
