...
export default function NewsletterPage() {
 ...
 <div className="bg-white p-4 rounded-xl border border-gray-200 flex flex-col sm:flex-row gap-4 items-center">
 ...
 className="pl-9 bg-gray-50 border-gray-200 text-white focus:border-primary/50 transition-colors"
 />
 </div>
 ...
 className="pl-9 bg-gray-50 border-gray-200 text-white w-full sm:w-[180px] [color-scheme:dark]"
 />
 </div>
 {dateFilter && (
 <button
 ...
 <Badge variant="outline" className="border-gray-200 text-gray-400">{filteredSubscribers.length} Records</Badge>
 </div>
 ...
 <TableRow key={sub.id} className="border-gray-200 hover:bg-white group">
 <TableCell>
 ...
 <DialogContent className="bg-zinc-950 border-gray-200 text-white sm:max-w-[425px]">
 <DialogHeader>
 ...
 <Input id="name" value={editName} onChange={(e) => setEditName(e.target.value)} className="bg-white border-gray-200 text-white" placeholder="John Doe" />
 </div>
 <div className="grid gap-2">
 <Label htmlFor="email" className="text-white">Email Address</Label>
 <Input id="email" value={editEmail} onChange={(e) => setEditEmail(e.target.value)} className="bg-white border-gray-200 text-white" />
 </div>
 </div>
 <DialogFooter>
 ...
 <AlertDialogContent className="bg-zinc-950 border-gray-200 text-white">
 <AlertDialogHeader>
 ...
 <AlertDialogFooter>
 <AlertDialogCancel className="bg-transparent border-gray-200 text-white hover:bg-white hover:text-white">Cancel</AlertDialogCancel>
