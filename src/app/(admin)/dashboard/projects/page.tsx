...
export default function ProjectsPage() {
 ...
 />
 <div className="absolute inset-0 bg-gray-50 opacity-0 transition-opacity group-hover:opacity-100 flex items-center justify-center gap-2 z-20 pointer-events-none">
