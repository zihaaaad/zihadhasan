...
export function ProjectTiltCard({ project }: { project: Project }) {
 ...
 className="group relative h-96 w-full rounded-2xl bg-white border border-gray-200"
 >
 <div
 ...
 <Badge key={tag} variant="secondary" className="bg-white text-black border-gray-200 text-[10px] uppercase tracking-widest font-bold">
 {tag}
 </Badge>
 ))}
 </div>
