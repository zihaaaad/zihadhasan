    ...
    <div className="flex h-16 items-center border-b border-border bg-background px-4 md:hidden">
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetTrigger asChild>
          <Button variant="ghost" size="icon" className="mr-4 text-foreground hover:bg-gray-100">
      ...
      <span className="text-lg font-bold tracking-tighter text-foreground">
        Zihad<span className="text-muted-foreground/80">.Admin</span>
      </span>
    </div>
  );
}
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="border-t border-gray-100 p-6 bg-gray-50/50">
        <Button
          variant="ghost"
          className="w-full justify-start gap-3 text-red-600 hover:bg-red-50 hover:text-red-700 font-bold uppercase tracking-[0.2em] text-[10px] h-12 rounded-xl"
