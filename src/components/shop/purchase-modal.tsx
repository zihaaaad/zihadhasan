            ...
            <DialogContent className="bg-black/90 border-white/10 text-white sm:max-w-[500px] backdrop-blur-xl">
                {!success ? (
                        ...
                        <div className="rounded-[1.5rem] border border-white/[0.05] bg-white/[0.02] p-6 space-y-4">
                            {settings?.paymentNumbers?.bkash && (
                                <div className="flex items-center justify-between">
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">bKash (Personal)</span>
                                    <div className="flex items-center gap-3">
                                        <span className="font-mono text-white font-bold">{bkashNumber}</span>
                                        <Button size="icon" variant="ghost" className="h-8 w-8 hover:bg-white/10 rounded-lg" onClick={() => copyNumber(bkashNumber)}>
                            ...
                            {settings?.paymentNumbers?.nagad && (
                                <div className="flex items-center justify-between">
                                    <span className="text-[10px] font-bold uppercase tracking-widest text-neutral-500">Nagad (Personal)</span>
                                    <div className="flex items-center gap-3">
                                        <span className="font-mono text-white font-bold">{nagadNumber}</span>
                                        <Button size="icon" variant="ghost" className="h-8 w-8 hover:bg-white/10 rounded-lg" onClick={() => copyNumber(nagadNumber)}>
                                            <Copy strokeWidth={1.5} className="h-3.5 w-3.5" />
                                        </Button>
                                    </div>
                                </div>
                            ...
                            {!settings?.paymentNumbers?.bkash && !settings?.paymentNumbers?.nagad && (
                                <div className="text-center text-[10px] font-bold uppercase tracking-widest text-neutral-600 py-2">
                            ...
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 py-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <FormField
                                        ...
                                        render={({ field }) => (
                                            <FormItem>
                                                <FormLabel className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 ml-1">Terminal ID</FormLabel>
                                                <FormControl>
                                                    <Input className="bg-white/[0.03] border-white/[0.05] h-12 rounded-xl text-white font-bold" {...field} />
                                                </FormControl>
                                                <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 ml-1">Transmission@Email</FormLabel>
                                            <FormControl>
                                                <Input className="bg-white/[0.03] border-white/[0.05] h-12 rounded-xl text-white font-bold" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input
                                                    placeholder="E.G. 8X2..."
                                                    className="bg-white/[0.03] border-white/[0.1] focus-visible:ring-white/20 h-12 rounded-xl text-white font-mono uppercase"
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage />
                    ...
                    <div className="py-12 flex flex-col items-center text-center">
                        <div className="h-20 w-20 rounded-full bg-white/[0.05] border border-white/10 flex items-center justify-center mb-8 relative">
                        ...
                        <DialogDescription className="text-neutral-500 text-sm font-medium mb-10 max-w-xs leading-relaxed">
                            Verification protocols initiated. You will be notified once access is authorized.
                        </DialogDescription>
                        <Button onClick={handleClose} className="w-full bg-white/5 border border-white/10 hover:bg-white/10 text-white h-12 rounded-xl text-[10px] font-bold uppercase tracking-widest">
                            Dismiss
                        </Button>
                    </div>
                )}
