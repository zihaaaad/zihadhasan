...
export function EnrollmentModal({ course, open, onOpenChange, onSuccess }: EnrollmentModalProps) {
 ...
 <DialogContent className="max-w-md bg-gray-50 border-gray-200 text-white max-h-[90vh] overflow-y-auto">
 <DialogHeader>
 ...
 <div className="p-8 bg-white/[0.03] border border-gray-200 rounded-3xl">
 ...
 <div className="bg-white/[0.02] p-6 rounded-3xl border border-gray-200 space-y-4">
 <div className="flex justify-between items-center">
 <span className="text-[10px] font-bold uppercase tracking-widest text-gray-500">Course Value</span>
 ...
 <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1">Transmission Gateway</Label>
 <div className="space-y-3">
 <Select value={paymentMethod} onValueChange={setPaymentMethod}>
 <SelectTrigger className="w-full bg-gray-50 border-gray-200 h-12 rounded-xl text-xs font-bold uppercase tracking-widest px-4">
 <SelectValue />
 </SelectTrigger>
 ...
 <div className="bg-white/[0.03] border border-gray-200 rounded-2xl p-4 space-y-3">
 ...
 <span className="text-gray-500 uppercase font-bold tracking-widest text-[9px]">Institution</span>
 <span className="text-white font-bold">{bank.bankName}</span>
 </div>
 <div className="flex justify-between items-center">
 <span className="text-gray-500 uppercase font-bold tracking-widest text-[9px]">ID / Number</span>
 <div className="flex items-center gap-2">
 <span className="font-mono text-white font-bold">{bank.accountNumber}</span>
 <button onClick={() => handleCopy(bank.accountNumber)} className="text-gray-500 hover:text-white transition-colors">
 {copied === bank.accountNumber ? <Check strokeWidth={1.5} className="h-3 w-3 text-white" /> : <Copy strokeWidth={1.5} className="h-3 w-3" />}
 </button>
 </div>
 </div>
 <div className="flex justify-between">
 <span className="text-gray-500 uppercase font-bold tracking-widest text-[9px]">Recipient</span>
 ...
 <span className="text-gray-500 uppercase font-bold tracking-widest text-[9px]">{paymentMethod} Number</span>
 <div className="flex items-center gap-2">
 ...
 * Verify payment completion before proceeding with the authorization request.
 ...
 <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1">Terminal ID (Phone)</Label>
 <Input
 required
 value={phone}
 onChange={e => setPhone(e.target.value)}
 placeholder="E.G. 01712345678"
 className="bg-gray-50 border-gray-200 h-12 rounded-xl text-white font-bold"
 />
 </div>

 <div className="space-y-2">
 <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1">Transaction Proof (TrxID)</Label>
 <Input
 required
 value={trxId}
 onChange={e => setTrxId(e.target.value)}
 placeholder="E.G. 8JKS92KL"
 className="bg-gray-50 border-gray-200 font-mono uppercase h-12 rounded-xl text-white font-bold"
 />
 </div>

 <div className="space-y-2">
 <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1">Visual Receipt (Optional)</Label>
 <ImageUploader
 value={screenshotUrl}
 ...
 <div className="space-y-2">
 <Label className="text-[10px] font-bold uppercase tracking-widest text-gray-500 ml-1">Notes (Optional)</Label>
 <Textarea
 value={additionalInfo}
 onChange={e => setAdditionalInfo(e.target.value)}
 placeholder="Any technical notes for verification..."
 className="bg-gray-50 border-gray-200 min-h-[100px] rounded-2xl text-white leading-relaxed"
 />
 </div>
