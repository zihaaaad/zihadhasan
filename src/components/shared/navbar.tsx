...
export function Navbar() {
 ...
 scrolled
 ? "bg-gray-50 sm:w-full md:max-w-3xl border-white/[0.1]"
 ...
 <div className="h-8 w-8 rounded-full bg-white/[0.03] overflow-hidden border border-white/[0.08] group-hover:border-gray-200 transition-all duration-500 relative">
 {profile?.photoURL ? (
 ...
 size="sm"
 variant="outline"
 className="rounded-full border-gray-200 bg-white text-[10px] font-bold uppercase tracking-[0.2em] text-white hover:bg-white hover:text-black transition-all duration-500 h-8"
 asChild
 >
 ...
 exit={{ opacity: 0, y: -20 }}
 className="absolute left-0 right-0 top-full mt-2 mx-4 rounded-3xl border border-gray-200 bg-gray-50 p-6 md:hidden"
 >
